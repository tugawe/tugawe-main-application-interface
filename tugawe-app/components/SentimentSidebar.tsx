...
export default function SentimentSidebar({ 
  ...
  const menuItems = [
    ...
    { id: 'sentiment-by-category', label: 'Sentiment by category' },
    { id: 'reviews-by-sentiment', label: 'Reviews by sentiment' },
    { id: 'sentiment-insights', label: 'Sentiment insights' },
  ];
